	...
	public void OnFirstUpdate()
	{
		try
		{
			...
			if (targetAsset != null)
			{
				...
				title.text = System.IO.Path.GetFileName(assetPath);
				if (assetPath.StartsWithIgnoreCase("assets/"))
				{
					assetPath = assetPath.Substring("Assets/".Length, assetPath.Length - "Assets/".Length - title.text.Length);
					title.tooltip = assetPath == "" ? null : title.text + " \nin " + assetPath;
				}
